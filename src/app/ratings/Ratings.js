...
const Ratings = ({ rating, children }) => (
  <div className="ratings">
    <span className="ratings__icon">
      {inRange(rating, 0, 1.1) && <SadIcon />}
      {inRange(rating, 1.1, 2.1) && <WonderingIcon />}
      {inRange(rating, 2.1, 3.1) && <NeutralIcon />}
      {inRange(rating, 3.1, 4.1) && <SmileIcon />}
      {inRange(rating, 4.1, 5.1) && <HappyIcon />}
    </span>
    {children && (
